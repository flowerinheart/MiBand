package com.martindisch.accelerometer.Model;
...
public class Profile {
    // ========================== 服务部分 ============================
    public static HashMap<UUID, String> nameMap = new HashMap<UUID, String>();
    /**
     * 主要的service
     */
    ...
    static {
        nameMap.put(UUID_SERVICE_MILI, "MILI");
        nameMap.put(UUID_SERVICE_VIBRATION, "VIBRATION");
        nameMap.put(UUID_SERVICE_HEARTRATE, "HEARTRATE");
    }
    ...
    static {
        nameMap.put(UUID_DESCRIPTOR_UPDATE_NOTIFICATION, "update descriptor");
        nameMap.put(UUID_NOTIFICATION_HEARTRATE, "heartrate notification");
    }
    ...
    static {
        nameMap.put(UUID_CHAR_DEVICE_INFO, "device info");
        nameMap.put(UUID_CHAR_DEVICE_NAME, "device name");
    }
    /**
     * 通用通知
     */
